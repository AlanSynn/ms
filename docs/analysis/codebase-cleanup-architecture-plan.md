...
- `App.tsx` is now a composition shell after mechanism action, stage navigation, and stage-router prop grouping extraction; the next App seams are stage-adjacent preview/control splits, not renderer or fabrication logic.
