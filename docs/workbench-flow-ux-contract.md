...
This is the compact UX contract for the current MotionSmith workbench. It does not replace `AGENTS.md`, `README.md`, `docs/subsystem-governance-and-mechanism-contracts.md`, or mechanism-specific PRDs. It names how those rules show up in the app shell.

## Source order

1. `AGENTS.md` and `README.md` define product direction and runtime copy policy.
