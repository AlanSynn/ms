...
Created: 2026-06-25
Parent docs: [`toon-25d-main-3d-unlock-plan.md`](toon-25d-main-3d-unlock-plan.md), [`novice-canva-style-ui-plan.md`](novice-canva-style-ui-plan.md)
...
- `ThreePuppetPreview` owns the active Character/Path/Blueprint scene surface; shared `ThreeFoundryPreview` owns Foundry/Assembly mechanism scenes, and blueprint SVG renderers remain export-only. Do not revive deleted `Canvas.tsx`; future workbench changes must consume projection data and mirror selection through existing ids.
