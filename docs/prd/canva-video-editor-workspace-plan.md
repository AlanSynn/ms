...
Status: superseded planning document. The rebuild requirements doc it depended on was removed 2026-08-31; current contracts live in `../AGENTS.md` and `../workbench-flow-ux-contract.md`.
