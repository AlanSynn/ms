...
Capture env: `QT_QPA_PLATFORM=offscreen uv run python ui-to-web/tools/capture_ui_screenshots.py`
Purpose: preserve real Qt runtime layout — tab composition, panel density, button placement, grid/canvas positions — refs for web rebuild.
...
| ![](screenshots/04-main-tab-mechanism-foundry.png) | Mechanism Foundry gallery | GalleryView card-based mechanism selection |
| ![](screenshots/90-options-dialog.png) | Options dialog | Appearance/Simulation/Performance/Workflow/Fabrication/Grid settings |
| ![](screenshots/91-processing-steps-group.png) | ProcessingStepsGroup | Processing button group |
