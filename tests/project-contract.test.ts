...
assert(codebaseCleanupPlan.includes('`App.tsx` | 9940') && codebaseCleanupPlan.includes('First split'), 'cleanup plan records the current App.tsx hotspot and first split target');
