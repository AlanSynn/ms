...
assert(appCommandSource.includes('<AppWorkspaceShell') && appCommandSource.includes('workflowStatus={workflowStatus}') && appCommandSource.includes('stageRouterProps={stageRouterProps}') && appCommandSource.includes('buildAppStageRouterProps') && appStageRouterPropsText.includes('export type AppStageRouterPropGroups') && appStageRouterPropsText.includes(': AppStageRouterProps =>') && appStageRouterPropsText.includes('foundryStage') && appStageRouterPropsText.includes('...assembly') && !appStageRouterPropsText.includes('return (') && !appStageRouterPropsText.includes('useState') && !appStageRouterPropsText.includes('React') && !appCommandSource.includes('app-header') && !appCommandSource.includes('quick-toolbar') && !appCommandSource.includes('WorkflowStatusStrip'), 'App delegates workspace shell markup and pure stage-router prop grouping while preserving status and stage-router props');
