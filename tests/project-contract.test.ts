...
assert(normalizedCodebaseCleanupPlan.includes('`App.tsx` | 1376') && normalizedCodebaseCleanupPlan.includes('Command keyboard binding, boot/cache lifecycle, and Character/Path/Foundry/Options/Assembly/Mechanism Design stage seams are extracted') && normalizedCodebaseCleanupPlan.includes('`hooks/useAppOnnxBootstrap.ts` | 88'), 'cleanup plan records the current App.tsx hotspot and completed command/stage seams');
