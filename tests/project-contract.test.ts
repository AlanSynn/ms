...
assert(characterImportControlsText.includes('character-add-scene-object') && characterImportControlsText.includes('Load object file') && characterSelectionText.includes('createDefaultSceneObject("piggy-bank")') && sceneObjectInspectorText.includes('data-testid="scene-object-inspector"') && sceneObjectInspectorText.includes('Delete object'), 'Character tab exclusively owns scene object creation and object-property editing');
