...
assert(pullRequestWorkflowText.includes('pull_request:') && pullRequestWorkflowText.includes('lfs: true') && pullRequestWorkflowText.includes('bun run test') && pullRequestWorkflowText.includes('--shard=1/8') && pullRequestWorkflowText.includes('--shard=8/8') && pullRequestWorkflowText.includes('bun run test:image-ai:performance') && pullRequestWorkflowText.includes('bun run test:study:browser'), 'pull requests fetch LFS and run contracts, eight production-preview browser shards, isolated image performance, and study gates');
