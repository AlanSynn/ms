...
assert(normalizedCodebaseCleanupPlan.includes('`App.tsx` | 4839') && normalizedCodebaseCleanupPlan.includes('shared Foundry/Design Three preview seams are extracted'), 'cleanup plan records the current App.tsx hotspot and completed Foundry renderer seams');
...
const foundry3dText = `${threeFoundryPreviewText}
...
assert(appText.includes('data-viewer-contract={VIEWER3D_CONTRACT_VERSION}') && foundry3dText.includes('data-viewer-contract={VIEWER3D_CONTRACT_VERSION}') && threePreviewText.includes('data-viewer-contract={VIEWER3D_CONTRACT_VERSION}'), '3D viewer state exposes a shared contract marker across tabs');
