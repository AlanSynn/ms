...
assert(chromebookAuditDoc.includes('396,005 bytes') && chromebookAuditDoc.includes('457,044 bytes'), 'audit document records the checked production bundle evidence');
