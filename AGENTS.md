...
- Getting Started can be reopened from the Character/Getting Started action and stays compact/result-first: Guide, Starter rig, and Character file tiles, plus Open full project as secondary. Do not ship image-recognition or Boy/Girl recognition starter assets. Avoid process/explanation copy in the modal.
