...
- Getting Started can be reopened from the Character/Getting Started action and stays compact/result-first: Guide, Starter rig, Image, and Character file tiles, plus Open full project as secondary. Keep bundled Boy/Girl starter assets out of the first landing surface until a secondary starter library exists. Avoid process/explanation copy in the modal.
