...
import { fabricationRecipeStackSummary } from "../../../utils/fabrication";
...
export const FoundryInspectorPanel = ({
  ...
  const graphFabrication = compileMechanismGraphFabrication(foundry, kit);
  const readableStack = graphFabrication.recipe
    ? fabricationRecipeStackSummary(graphFabrication.recipe)
    : `Fix: ${graphFabrication.blocker ?? "Graph fabrication blocked"}`;
  ...
  return (
    <div className="stage-pane-stack">
      ...
      >
        <strong>Stack</strong>
        <span title={readableStack} data-stack-raw={readableStack}>
          {readableStack}
        </span>
      </div>
      <div
        className="foundry-view-controls"
        data-testid="foundry-view-controls"
      >
        ...
        <div className="foundry-view-controls-grid">
          ...
          >
            ...
            <input
              ...
              onChange={(event) =>
                onRigOpacityChange(Number(event.target.value))
              }
            />
          </div>
          <div
      ...
      <details className="advanced-panel">
        ...
        <div className="mt-3 space-y-3">
          ...
          {MECHANISM_PARAM_META.filter((param) =>
            ...
            const safeRange = motionSafeParamRange(foundry, param.key, kit);
            return (
