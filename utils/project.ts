...
export const createDefaultMechanism = (type: MechanismConfig['type'] = '4bar', id = uid('mech')): MechanismConfig => ({
    ...
    groundLength: type === 'piston' || type === 'yoke' || type === 'cam' ? 0 : 180,
    crankLength: type === '5bar' ? 60 : type === 'gear' ? 44 : type === 'planetary_gear' ? 38 : 50,
    couplerLength: type === 'yoke' || type === 'cam' || type === 'gear' || type === 'planetary_gear' ? 0 : 165,
    rockerLength: type === '5bar' ? 48 : type === 'quick-return' ? 130 : type === 'planetary_gear' ? 36 : type === 'cam' ? 80 : 110,
    sliderOffset: type === 'piston' ? 34 : 0,
    couplerPointDist: type === '5bar' ? 90 : 78,
    couplerPointAngle: type === 'piston' ? 0 : 40,
    speed1: 1,
...
const normalizeMechanismSnapshot = (value: unknown): MechanismConfig => {
    ...
    return {
        ...
        crankLength: clampNumber(raw.crankLength, base.crankLength, 1, 10000),
        couplerLength: clampNumber(raw.couplerLength, base.couplerLength, 0, 10000),
        rockerLength: clampNumber(raw.rockerLength, base.rockerLength, 1, 10000),
