export const WEB_IMAGE_LIMITS = {
  maxWorkingEdge: 1_024,
  maxWorkingPixels: 1_000_000,
  maxSourceTextureEdge: 512,
  maxSourceTextureBytes: 256 * 1_024,
  maxMaskBytes: 128 * 1_024,
} as const;
...
export const boundedImageSize = (
  ...
  if (!Number.isFinite(maxEdge) || !Number.isFinite(maxPixels) || maxEdge <= 0 || maxPixels <= 0) {
